...
ADDON=xbmcaddon.Addon(id='plugin.video.AlbiliaWizard')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/978f0ditp892ggy/wizard.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]Albilia Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
